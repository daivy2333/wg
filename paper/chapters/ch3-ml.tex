...
完整 Top-20 分布如图8 所示（与第2章特征工程中的图同源）。
...
较 5 类随机基线提升显著。图10 给出了 RF 在二分类任务上的混淆矩阵热力图。
...
在训练分布内的交叉验证中，DT 的 CV-f1 约为 0.77，RF 的 CV-f1 高达 0.99，看似接近完美，
但统一测试集上 DT 与 RF 的 f1 分别仅为 0.76 和 0.69，下降幅度达 10-30 个百分点。
