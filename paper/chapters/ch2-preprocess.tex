...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.95\textwidth]{04_numeric_distributions.png}
\caption{数值特征分布}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.85\textwidth]{05_categorical_top10.png}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.95\textwidth]{07_log1p_before_after.png}
