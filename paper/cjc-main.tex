...
\classsetup{
  ...
  abstract     = {
    ...
    多分类任务（5大攻击类别）中，MLP准确率达81.0\%，DT与RF分别为74.3\%和73.7\%，但R2L和U2R等小类F1仍受限于训练样本的极度稀缺。
  ...
  abstract*    = {
    ...
    score of approximately 0.72, while Decision Tree reaches 0.76. In five-category multi-class classification,
    MLP achieves 81.0\% accuracy, DT 74.3\%, and RF 73.7\%, though R2L and U2R F1 remain constrained by
    extreme training sample scarcity. This paper provides a comprehensive experimental benchmark and methodological reference for NSL-KDD
